    ...
    return (
        <div className='Container'>
            ...
            <div>
                ...
                <p>
                   স্টেটঃ
                   স্টেট component এর information Hold করে। এইটা কে চাইলে পরিবতন করা যাই । এটা তার চাইল্ড কম্পোনেন্ট থেকে access করা যাই না । এইটা কে রিয়েক্ট কম্পোনেন্ট এর হাট বলা হয়ে থাকে এইটা নিদেশনা দেই কম্পোনেন্ট এর ব্যবহার কেমঅন হবে এবং কিভাবে render করবে।1 
                </p>
            </div>
        </div>
    );
